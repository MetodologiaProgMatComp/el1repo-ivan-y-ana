...
public class MainShape {
    public static void main(String[] args){
        ...
        //System.out.println(s1.getRadius()); "NO HAY getRadius EN SHAPE"
        ...
        Shape s3 = new Rectangle1(1.0, 2.0, "red", false); // Upcast
        System.out.println(s3);
        System.out.println(s3.getArea());
        System.out.println(s3.getPerimeter());
        System.out.println(s3.getColor());
        //System.out.println(s3.getLength()); "NO HAY getLength EN SHAPE"
        ...
        //System.out.println(s4.getSide()); "NO HAY getSide EN SHAPE"
        ...
        //System.out.println(r2.getSide()); "NO HAY getSide EN SHAPE"
