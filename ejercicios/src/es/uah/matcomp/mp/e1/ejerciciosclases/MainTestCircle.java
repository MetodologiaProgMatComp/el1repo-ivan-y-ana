...
import es.uah.matcomp.mp.e1.ejerciciosclases.EJ0.Circle;

/**
 * A Test Driver for the Circle class
 */
public class MainTestCircle {  // Save as "TestCircle.java"
    public static void main(String[] args) {
        ...
        // Invoke public methods on instance c1, via dot operator.
                System.out.println("The circle " + c1.getColor() + " has radius of "
        ...
        // Invoke public methods on instance c2, via dot operator.
                System.out.println("The circle " + c2.getColor() + " has radius of "
        ...
        // Invoke public methods on instance c3, via dot operator.
                System.out.println("The circle " + c3.getColor() + " has radius of "
